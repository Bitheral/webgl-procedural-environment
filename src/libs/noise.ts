...
/*
 * Adapted from Joseph Gentle's noise.js
 * Ported to TypeScipt for use in Three.js
 */
...
class Grad {
    ...
    dot3(x: number, y: number, z: number) {
        return this.p.x * x + this.p.y * y + this.p.z * z;
    }
}
...
export function simplexVector2(v: Vector2): number {
    return simplex2(v.x, v.y);
}
...
export function simplexVector3(v: Vector3): number {
    return simplex3(v.x, v.y, v.z);
}
...
export function perlinVector2(v: Vector2): number {
...
export function perlinVector3(v: Vector3): number {
    return perlin3(v.x, v.y, v.z);
}
